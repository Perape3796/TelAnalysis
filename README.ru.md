...
Открой <http://localhost:8501>. В сайдбаре укажи путь к `result.json` — для архивов от ~65 МБ режим **Путь к файлу** заметно быстрее drag-and-drop (нет base64 через WebSocket).
